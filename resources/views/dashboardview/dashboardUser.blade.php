...
<body>
    ...
    <div class="Dashboard-section">
        <img src="{{ asset('images.DashboardIcon.png') }}" alt="Logo" />
        <div class="text">
            <h1>Dashboard</h1>
    ...
    <div class="content">
        <div class="button-section">
            <div class="button-container">
                <a href="#" class="button">Ajukan Surat</a>
                <p class="description">Ajukan surat yang perlu ditandatangani oleh admin</p>
            </div>
            <div class="button-container">
                <a href="#" class="button">Surat Saya</a>
                <p class="description">Lihat daftar surat yang telah anda ajukan</p>
            </div>
        </div>
    </div>
